...
if (isset($_POST['submit'])) {
    if(($_POST['cgvState']) == 'false')
	{
		$retour ['message_cgv'] = 'Vous devez accepter les Conditions Générales de Vente avant de pouvoir procéder au paiement de vos achats';
	}
    else {
        for($i=0; $i < $c; $i++) {
    ...
    if (isset($ok) && $ok === true) {
		...
		if($mail->Send()){// remettre le '!'devant la condition
          echo $mail->ErrorInfo;
        }
        else{
